...
class Catalog_Mode_Admin {
	...
	// Setting section
	  public function catalog_mode_settings_fields( $general_settings ) {
		...
		$general_settings['catalog_mode_settings']['option_view_food_items'] = array(
			...
			'type'          => 'radio',
			'desc'          => __( 'For Use Of List View And Grid View Option ', 'rpress-catalog' ),
			'options' 		=> array(
	...
	public function remove_empty_cart_message() {
		if( rpress_get_option('catalog_mode_enable') == 1 ) {
			...
			return '<span class="rpress_empty_cart">' . __( 'Choose an item from the menu to get started.', 'rpress-catalog' ) . '</span>';
		}
	}
	public function remove_add_to_cart_button($label) {
		if( rpress_get_option('catalog_mode_enable') == 1 ) {
			...
			return '<span class="add_to_cart_button">' . __( 'Add', 'rpress-catalog' ) . '</span>';
		}
	...
	public function remove_rpress_cart_title($title) {
		...
		return '<span class="rpress_cart_title">' . __( 'Your Order', 'rpress-catalog' ) . '</span>';
	}
	}
